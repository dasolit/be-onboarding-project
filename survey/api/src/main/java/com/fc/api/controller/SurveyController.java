...
import com.fc.core.constant.ResponseConstants;
import com.fc.core.dto.ResponseApi;
import com.fc.core.dto.response.SurveyModResponse;
import com.fc.core.dto.response.SurveyRegResponse;
...
import com.fc.domain.service.SurveyService;
...
public class SurveyController {
  ...
  public ResponseApi<SurveyModResponse> updateSurvey(@RequestBody SurveyModDTO request){
    ...
    return new ResponseApi<>(
        ...
        new SurveyModResponse(survey.getId(), survey.getName(), survey.getDescription(), null)
    );
  }
