package com.fc.core.dto.request;
...
public class SurveyRegDTO {
  ...
  @Schema(description = "설문조사 상세 설명", example = "Inner Circle BE 1주차 OT 진행 만족도에 관한 설문조사 입니다.")
  private String description;

  @ArraySchema(
      schema = @Schema(implementation = QuestionRegDTO.class))
  private List<QuestionRegDTO> questions;
